...
# Example : gaussian noise removal on a video file or live camera stream
# specified on the command line (e.g. python gaussian_noise_filter.py video_file)
...
if (((args.video_file) and (cap.open(str(args.video_file))))
    ...
    while (keep_processing):
        ...
        noisy_guass = cv2.add(frame, gauss)
        ...
        median_img = cv2.medianBlur(noisy_guass, neighbourhood)
        ...
        cv2.putText(frame, 'Original Input', 
            ...
            fontColor,
            lineType)
        cv2.putText(noisy_guass, 'Gaussian Noise', 
            bottomLeftCornerOfText, 
            font, 
            fontScale,
            fontColor,
        ...
        im_1 = cv2.hconcat([frame, noisy_guass])
