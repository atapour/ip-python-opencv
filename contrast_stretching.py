...
# Example : contrast stretching on a video file or live cameran stream 
# from the command line (e.g. python contrast_stretching.py video_file)
...
parser = argparse.ArgumentParser(
    description='Perform Contrast Stretching on camera/video image.')
...
window_name = "Live Camera - Contrast Stretching"  # window name
...
if (((args.video_file) and (cap.open(str(args.video_file))))
    ...
    while (keep_processing):
        ...
        # perform the basic contrast stretching using normalisation
        ...
        cv2.putText(gray_img, 'Original Input', 
            ...
            fontColor,
            lineType)
        cv2.putText(output, 'Contrast Stretched', 
            bottomLeftCornerOfText, 
            font, 
            fontScale,
            fontColor,
